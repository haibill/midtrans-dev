...
$this->fields->formGroupRow('Name', '', 'text', 'name', $result['name'], 'Example: IPS', 'off', false, true);
$this->fields->textAreaRow('Description', '', 'description', $result['description'], 'Example: Belajar sejarah, geografi', false, true);
